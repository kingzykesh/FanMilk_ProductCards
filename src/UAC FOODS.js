export const characters = [
  // Iron Man
  {
    ...
    homeworld: "Earth",
    abilities: [
      "FanChoco is a chocolate flavoured frozen milk drink.",
      "It has the goodness and benefits of cocoa. FanChoco comes in 70ml, and 160ml pouches as well as a 180ml Tetrapak. ",
      "Superhuman strength",
    ],
    team: "Fan-milk limited",
    description:
  ...
  },
  {
    name: "FanVanille",
    alias: "FanVanille",
    abilities: ["FanVanille is Nigeria’s No 1 Frozen flavoured milk brand", "Its unique milk and vanilla flavour combination make for a refreshing on-the-go snack."],
    team: "Fan-milk limited",
     img1:"./3.jpg",
  ...
  },
  {
    name: "SuperYogo",
    alias: "SuperYogo",
    abilities: ["It comes in plain and lemon flavour and is available in 70ml and 160ml pouches as well as 180ml Tetrapak.", "Enjoy natural goodness with this nutritious and refreshing frozen yoghurt snack."],
    team: "Fan-milk limited",
    img1: "./4.jpg",
    homeworld: "Earth",
  ...
  },
  {
    name: "FanDango",
    alias: "FanDango",
    abilities: ["FanDango is a refreshing fruit drink ", "It is enriched in Vitamin C and comes in 2 formats: Pouch & Bottle."],
    team: "Fan-milk limited",
    img1: "./5.jpg",
    homeworld: "Earth",
...

  {
    name: "GO SLO",
    alias: "GO SLO",
    abilities: ["GoSlo is Nigeria’s first locally produced premium Ice-cream brand and Fan Milk West Africa’s first purposeful brand.", "Made with delicious, creamy Ice-cream base and inclusions, GoSlo is crafted to calm and delight for an amazing sensory experience."],
    team: "Fan-milk limited",
    img1: "./7.jpg",
    homeworld: "Earth",
    description:
  ...
  },
  {
    name: "FANICE",
    alias: "FANICE ",
    abilities: ["It comes in four exciting variants; Vanilla, Strawberry, Banana and Chocolate and is available in 250ml", "t has a 6-month shelf life."],
    team: "Fan-milk limited",
    img1: "./9.jpg",
    homeworld: "Earth",
    description:
